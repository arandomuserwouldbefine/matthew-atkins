  ...
  return (
    <>
      <div className="relative flex items-center justify-center min-h-[450px]">
        <form className="border flex items-center gap-4 flex-col py-5 px-5 w-full max-w-[500px] rounded-md shadow-md">
          <input
          ...
          <Button disabled={isDisabled} onClick={(e) => handleUploadClick(e)}>
